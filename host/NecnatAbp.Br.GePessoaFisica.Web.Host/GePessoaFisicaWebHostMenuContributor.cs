...
public class GePessoaFisicaWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public GePessoaFisicaWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<GePessoaFisicaResource>();
